...
export default function NotFound() {
  return (
    <div className="h-[100vh] w-[100vw]">
      <div className="relative flex flex-col h-full w-full items-center justify-center bg-[url(/images/404image-movil.png)] md:bg-[url(/images/404image.png)] bg-contain bg-no-repeat bg-center">
        <p

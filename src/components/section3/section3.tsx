    ...
    <div className="relative h-[150vh] w-[100vw]">
      <div className="w-full h-full max-w-[1450px]">
        ...
        <div className="w-full h-full flex items-center">
          {/*IMAGE*/}
          <div className="sm:w-[600px] sm:h-[600px] md:w-[80%] md:h-[80%] absolute right-[-50px] bottom-0 bg-[url(/images/branch2.png)] w-[550px] h-[550px] bg-contain bg-no-repeat bg-right"></div>
          {/*CONTENT DIV*/}
